...
from st13_survey_utils import estimate_by_group, estimate_prop, format_pct_ci  # noqa: E402
...
DHS_ROOT = RESEARCH_ROOT / "01_DHS_Data" / "KDHS_2022"
...
def main():
    ...
    adults.to_pickle(OUT_DERIVED / "st13_dhs_analytic.pkl")
    adults[
        [
            "sex",
            "age",
    ...
    ].to_csv(OUT_DERIVED / "st13_dhs_analytic_slim.csv", index=False)
